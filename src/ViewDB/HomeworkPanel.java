...
public class HomeworkPanel extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            homework.setId_class(classes.get(jComboBox2.getSelectedIndex()).getId_class());
            homework.setId_subject(subject.get(jComboBox4.getSelectedIndex()).getId_subject());
            homework.setId_teacher(teachers.get(jComboBox3.getSelectedIndex()).getId_teacher());
    ...
    private void jTable1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MousePressed
        ...
        try {
            for (Clas p : classes) {
                if (p.getId_class() == homework.getId_class()) {
                    jComboBox2.setSelectedItem(p.toString());
                    break;
                }
            }
            for (Teacher t : teachers) {
                if (t.getId_teacher() == homework.getId_teacher()) {
            ...
            for (Subject s : subject) {
                if (s.getId_subject() == homework.getId_subject()) {
    ...
    private void ShowTable() throws SQLException {
        ...
        for (Homework e : homeworks) {
            ...
            tableModel.addRow(new String[]{
                e.getId_homework() + "",
                cdb.one(e.getId_class()).toString(),
                t.toString(),
                sdb.one(e.getId_subject()).toString(),
                e.getHomework(),
                e.getDate() + ""});
        }
        try {
            WorkWithComboBox(tdb, cdb, sdb);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(null, "Не делайте так", "ERROR", JOptionPane.ERROR_MESSAGE);
        }
    }
